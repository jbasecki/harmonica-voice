...
export default function SuccessPage() {
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#000', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: '#D4AF37', fontFamily: 'serif', textAlign: 'center', padding: '20px' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, background: 'rgba(0,0,0,0.85)', padding: '60px', borderRadius: '40px', border: '2px solid #D4AF37', maxWidth: '650px', backdropFilter: 'blur(15px)', boxShadow: '0 0 50px rgba(212,175,55,0.2)' }}>
        ...
        <button 
          ...
          style={{ background: '#D4AF37', color: '#000', border: 'none', padding: '15px 50px', borderRadius: '50px', cursor: 'pointer', letterSpacing: '3px', fontWeight: 'bold', fontSize: '0.9rem' }}>
          RETURN TO STUDIO
        </button>
      </div>
    </main>
